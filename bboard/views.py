...
def index(request):
    ...
    total_price = Bb.objects.all().aggregate(total_price=Sum('price'))['total_price']
    min_max_price = Bb.objects.all().aggregate(min_price=Min('price'), max_price=Max('price'))
    context = {'bbs': bbs, 'rubrics': rubrics,'total_price': total_price,'min_price': min_max_price['min_price'],'max_price': min_max_price['max_price']}
